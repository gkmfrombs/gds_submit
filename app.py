...
function_definitions_llm = [
    {
        ...
        "parameters": {
            ...
            "required": ["filename", "targetfile", "email", "url"],
        }
    },
    {
        "name": "A2",
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "query": {
                    "type": "string",
                    "pattern": """SELECT SUM(units * price) AS total_sales
                                    FROM tickets
    ...
    "parameters": {  
        ...
        "properties": {  
            ...
            "quality": {  
                ...
                "minimum": 1,  
                "maximum": 100,  
                "description": "Optional. Quality of the output image as a percentage."  
            },  
            "compress": {  
                "type": "boolean",  
                "description": "Optional. Whether to compress the output image."  
            },  
            "resize": {  
                "type": "array",  
                "items": {  
        ...
        "required": ["image_path", "output_path", "resize", "compress", "quality"]  
    }  
},
{  
    "name": "B8",  
    "description": "Convert an audio file to another format and save the result to the specified output path.",  
    "parameters": {  
        "type": "object",  
        "properties": {  
            "audio_path": {  
            ...
            "output_path": {  
                "type": "string",  
                "pattern": ".*/.*",  
                "description": "Path to save the converted audio file."  
            }  
        },  
